...
/***/ function(module, exports, __webpack_require__) {
	...
	var cowMergedBones = [];
	for (var i = 0; i < cow.bones.length; i += 1) {
	  var quadBone = quadruped.bones[i];
	  var cowBone = cow.bones[i];
	  if (cowBone.reset) {
	    cowMergedBones.push(cowBone);
	  } else {
	    cowMergedBones.push((0, _lodash.merge)({}, quadBone, cowBone));
	  }
	}
	...
	function init() {
	  ...
	  cowMerged.bones.forEach(function (geometryBone, boneIndex) {
	    ...
	    cubes.forEach(function (cube) {
	      ...
	      for (var _i = 0; _i < boxGeometry.vertices.length; _i += 1) {
