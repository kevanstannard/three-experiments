...
/***/ function(module, exports, __webpack_require__) {
	...
	function init() {
	  ...
	  var texture = textureLoader.load('../../assets/textures/minecraft/entities/pig.png');
	  ...
	  _pig2.default.bones.forEach(function (bone) {
	    var pivot = bone.pivot;
	    var part = new THREE.Object3D();
	    part.name = bone.name;
	    part.position.set(pivot[0], pivot[1], pivot[2]);
	    part.add(new _Pivot2.default());
	    parts.push(part);
	    bone.cubes.forEach(function (cube, cudeIndex) {
	      var origin = cube.origin;

	      var _cube$size = _slicedToArray(cube.size, 3),
	          width = _cube$size[0],
	          height = _cube$size[1],
	          depth = _cube$size[2];

	      var _cube$uv = _slicedToArray(cube.uv, 2),
	          u = _cube$uv[0],
	          v = _cube$uv[1];
	      ...
	      var yoff = height / 2;
	      var zoff = depth / 2;
	      var x = origin[0] + xoff - pivot[0];
	      var y = origin[1] + yoff - pivot[1];
	      var z = origin[2] + zoff - pivot[2];
	      var geometry = new _MinecraftBoxGeometry2.default(u, v, width, height, depth);
...
/***/ function(module, exports) {
	...
	function MinecraftHeadGeometry(u, v, width, height, depth) {
	  var box = {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mergedBones = [];
	for (var i = 0; i < mob.bones.length; i += 1) {
	  var quadBone = _quadruped2.default.bones[i];
	  var mobBone = mob.bones[i];
	  if (mobBone.reset) {
	    mergedBones.push(mobBone);
	  } else {
	    mergedBones.push((0, _lodash.merge)({}, quadBone, mobBone));
	  }
	}
