...
function init() {
  ...
  const material = new THREE.MultiMaterial([
    new THREE.MeshBasicMaterial({ ...baseOptions, color: 0xff0000 }),
    new THREE.MeshBasicMaterial({ ...baseOptions, color: 0x00ff00 }),
    new THREE.MeshBasicMaterial({ ...baseOptions, color: 0x0000ff }),
  ]);
