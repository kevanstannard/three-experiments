...
export function script() {
  ...
  function init() {
    ...
    // Pixellated texture
    const steveTexture = textureLoader.load(
      "assets/textures/minecraft/skins/steve.png"
    );
    ...
    // Pixellated texture
    const alexTexture = textureLoader.load(
      "assets/textures/minecraft/skins/alex.png"
    );
